            ...
            <nav :class="{'flex': open, 'hidden': !open}">
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        class="flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-center bg-transparent rounded-lg md:w-auto md:inline md:mt-0 md:ml-2 hover:text-white focus:text-white hover:bg-indigo-400 focus:bg-indigo-400 focus:outline-none focus:shadow-outline">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="px-2 py-2 #3d68ff  rounded-md shadow dark-mode:bg-gray-800">
                            <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg  md:mt-0 hover:text-white focus:text-white hover:bg-indigo-400 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                                href="data_guru.php">Data Guru</a>
                            <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg md:mt-0 hover:text-white focus:text-white hover:bg-indigo-400 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                                href="data_staff.php">Data Staff</a>
                        </div>
                    </div>
                </div>
            </nav>
