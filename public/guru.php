                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500"><?php echo $d['tugas_tambahan']; ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo $d['tempat_lahir']; ?>
                                        </div>
                                        <div class="text-sm text-gray-500"><?php echo $d['tanggal_lahir']; ?>
                                        </div>
                                    </td>
